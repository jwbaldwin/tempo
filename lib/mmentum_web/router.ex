defmodule MmentumWeb.Router do
  use MmentumWeb, :router
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {MmentumWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: MmentumWeb.Telemetry
    end
  end
